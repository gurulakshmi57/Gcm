...
public class post_businessforsale_ad {
	@Test(dataProvider = "testdata")
	public void postbrokad(String bussaletitle,String buscategory, String category1, String category2,String category3, String category4, 
			...
			String Village, String Area, String Zipcode, String listprice, String Grossannual, String Grossannualpro, String Netpro, String downpay,
			String Caprate, String ROR, String Bizoperhours, String noofemp, String Yearofestablish,String Currentownersinceyear, String Buildingbizarea,
			String Lotsize, String Totalnoofparkings, String Resparkings, String Rent,String Curleasexp, String anyspeclic,String Sellertriperiod,
			String Addesc, String Offlisting, String Reasonforsale, String Companylogo1, String Companylogo2, String Companylogo3,String Companylogo4, 
			String audio, String video, String yourcoms, String Dis) throws Exception {
	
		if(bussaletitle!=null && bussaletitle!="")
		{
			...
			Thread.sleep(2000);
		    d.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_rdservicetype_1']")).click();
		    Thread.sleep(2000);
		    d.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_ImageButton1']")).click();
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtAdTitle']")).sendKeys(bussaletitle.trim());
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$ddlcat']")).sendKeys(buscategory.trim());
			Thread.sleep(2000);
			...
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtcost']")).sendKeys(listprice.trim());
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtannual']")).sendKeys(Grossannual.trim());
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtGrossProfit']")).sendKeys(Grossannualpro.trim());
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtNetProfit']")).sendKeys(Netpro.trim());
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtDownPayment']")).sendKeys(Netpro.trim());
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtYear']")).sendKeys(Yearofestablish.trim());
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtRent']")).sendKeys(Rent.trim());
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtLeaseExpiry']")).sendKeys(Curleasexp.trim());
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtsplic']")).sendKeys(anyspeclic.trim());
			Thread.sleep(2000);
			d.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$txtPeriod']")).sendKeys(Sellertriperiod.trim());
			Thread.sleep(2000);
	...
	{
		File f= new File("D:\\Selenium\\Postbusinessforsale.xls");
